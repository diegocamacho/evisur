<?
$sql = "SELECT tareas.*, usuarios.nombre FROM tareas JOIN usuarios ON tareas.id_remite = usuarios.id_usuario WHERE id_destino = $s_id_usuario AND tareas.activo = 1 AND terminado_creador = 0 AND terminado_destino = 0 ORDER BY leido ASC, fecha_limite ASC";
$q = mysql_query($sql);
