                                                    ...
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-green-steel uppercase bold">Indicador 1</span>
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="row list-separated">
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    <div class="font-grey-mint font-sm"> Indicador </div>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption caption-md">
                                                                <i class="icon-bar-chart font-dark hide"></i>
                                                                <span class="caption-subject font-green-steel bold uppercase">Actividades de usuarios</span>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                                            ...
                                                            <div class="table-scrollable table-scrollable-borderless">
                                                                <table class="table table-hover table-light">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Sharon Vivanco</a>
                                                                        </td>
                                                                        <td> $345 </td>
                                                                        <td> 45 </td>
                                                                        <td> 124 </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Daniel Bass</a>
                                                                        </td>
                                                                        <td> $560 </td>
                                                                        <td> 12 </td>
                                                                        <td> 24 </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="fit">
                                                                            <img class="user-pic rounded" src="assets/pages/media/users/avatar6.jpg"> </td>
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">María Izquierdo</a>
                                                                        </td>
                                                                        <td> $1,345 </td>
                                                                        <td> 450 </td>
                                                                        <td> 46 </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Luis Matos</a>
                                                                        </td>
                                                                        <td> $645 </td>
                                                                        <td> 50 </td>
                                                                        <td> 89 </td>
